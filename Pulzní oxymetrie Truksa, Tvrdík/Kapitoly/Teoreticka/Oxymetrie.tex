...
\par Transportní protein hemoglobin, který má v těle funkci přenosu některých plynů, se vyskytuje v erytrocytech většiny obratlovců. Pro plnění své funkce je schopen na sebe tyto plyny navázat a následně je vypustit. Při navázání různých plynů se mění jeho vlastnosti, čehož lze využít pro rozpoznání jednotlivých plynů, jež jsou na něj navázány.
